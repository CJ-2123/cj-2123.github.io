**Goal: Obtain Master Chef achievement (cook all recipes with an excellent rating)**
...
Chinese Takeout in laugh floor area northernmost desk has Filet Mignon (need 1)
